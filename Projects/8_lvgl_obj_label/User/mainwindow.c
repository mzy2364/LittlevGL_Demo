...
void lv_obj_label_test(void)
{
	...
	lv_label_set_style(label1,LV_LABEL_STYLE_MAIN,&style_cn_32);	/* 设置为中文字体的style */
	...
	lv_label_set_style(label2,LV_LABEL_STYLE_MAIN,&style_cn_24);	/* 设置为中文字体的style */
	...
	lv_label_set_style(label3,LV_LABEL_STYLE_MAIN,&style_cn_32);	/* 设置为中文字体的style */
	lv_label_set_text(label3,"这是一个长文本 会滚动显示 跳兔科技,所行不止所想");	/* 设置长文本 */
	...
	lv_label_set_style(label4,LV_LABEL_STYLE_MAIN,&style_cn_32);	/* 设置为中文字体的style */
	lv_label_set_recolor(label4, true);								/* 允许文字重新着色 */
	lv_label_set_text(label4,"#000080 多种##000000 颜色##6666ff 的文本#");	/* 设置不同颜色的文本,注意#号包含以及空格 */
