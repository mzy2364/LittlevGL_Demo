...
{
	i2c3_mem_read(EEPROM_ADDRESS,mem_addr,I2C_MEMADD_8BIT,pbuffer,num_byte_to_read,1000);
}
...
static void eeprom_page_write(uint8_t mem_addr,uint8_t *pbuffer, uint8_t num_byte_to_write)
{
	i2c3_mem_write(EEPROM_ADDRESS,mem_addr,I2C_MEMADD_8BIT,pbuffer,num_byte_to_write,1000);
	delay_ms(5);
}
