...
/* USER */
/* LVGL字体文件的SDRAM存储地址 */
#define LV_USER_FONT_ADDR	((uint32_t)0xC0C00000)
/* LVGL字体文件的最大值 */
#define LV_USER_FONT_MAX_SIZE	(10*1024*1024)
...
/* 字体bin文件的偏移 */
#define LV_USER_FONT_OFFSET_12	((uint32_t)0x00000000)
#define LV_USER_FONT_OFFSET_16	((uint32_t)0x000BDD8E)
#define LV_USER_FONT_OFFSET_24	((uint32_t)0x0020A85A)
#define LV_USER_FONT_OFFSET_32	((uint32_t)0x0047FAE8)
