...
void lv_tutorial_image(void)
{
...
#if LV_COLOR_DEPTH == 8
	//lv_examples\lv_tutorial\5_antialiasing\6_images\blue_flower_8.bin
    lv_img_set_src(img_bin, "P:\lv_examples\lv_tutorial\5_antialiasing\6_images\blue_flower_8.bin");
	...
	//lv_img_set_src(img_bin, "P:/tiaotu48.bin");
